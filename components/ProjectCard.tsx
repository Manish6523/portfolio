...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, index }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative md:pb-0 pb-5 border-b md:border-0"
    >
      <div className="flex flex-col lg:flex-row md:gap-16 gap-8 items-start">
        ...
        <div className="w-full lg:w-2/5 space-y-8">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed max-w-md border-l border-zinc-900 pl-6 py-1">
            {project.description}
          </p>
